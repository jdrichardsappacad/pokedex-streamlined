...
const UPDATE_ONE = 'pokemon/UPDATE_ONE';
const GET_ONE = 'pokemon/GET_SINGLE_POKEMON';
...
const addOne = pokemon => ({
  type: ADD_ONE,
  pokemon,
});

const updateOne = pokemon => ({
  type: UPDATE_ONE,
  pokemon,
});
